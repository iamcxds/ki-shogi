...
const S = {
  zh: {
    ...
    ai_battle: 'AI 对战',
    tutorial: '规则教程',
    press_123: '按 1, 2 或 3 选择  L:语言/Lang',
    choose_pieces: '选择棋子:',
    basic_set: '基础版 (玉+飛+角)',
    full_set: '完整版 (玉+飛+角+麒)',
    press_12: '按 1 或 2 选择  L:语言/Lang',
    choose_diff: '选择难度:',
    diff_easy: '简单 (随机走棋)',
    ...
    random: '随机',
    ai_vs_ai: 'AI 对战 AI',
    press_1234: '按 1, 2, 3 或 4 选择  L:语言/Lang',
    // Game
    black: '黒 Black',
    white: '白 White',
    black_short: '黒',
  ...
  en: {
    ...
    random: 'Random',
    ai_vs_ai: 'AI vs AI',
    press_1234: 'Press 1, 2, 3 or 4  L:语言/Lang',
    black: '黒 Black',
    white: '白 White',
    black_short: '黒',
    white_short: '白',
